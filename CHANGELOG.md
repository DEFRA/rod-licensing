Error: Command failed: git log --oneline --pretty=hash<%h> ref<%D> message<%s> date<%cd> --date=short v0.0.1..0.0.2
fatal: ambiguous argument 'v0.0.1..0.0.2': unknown revision or path not in the working tree.
