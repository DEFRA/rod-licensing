...
describe('deliverFulfilmentFiles', () => {
  ...
  it('delivers all fulfilment files marked with the Exported status to the fulfilment provider', async () => {
    ...
    // Streams for file1
    const { s3DataStreamFile: s3DataStreamFile1, ftpDataStreamFile: ftpDataStreamFile1 } = createMockFileStreams()

    // Streams for file2
    const { s3DataStreamFile: s3DataStreamFile2, ftpDataStreamFile: ftpDataStreamFile2 } = createMockFileStreams()
