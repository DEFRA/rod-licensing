...
describe('document client decorations', () => {
  ...
  describe('createUpdateExpression', () => {
    ...
    // it('returns an UpdateExpression with SET and REMOVE expressions', () => {
    //   const docClient = createDocumentClient()
    //   const actual = docClient.createUpdateExpression({id: 1, data: Symbol('data1'), data2: Symbol('data2')})
    //   expect(actual.UpdateExpression).toMatch(/SET #data = :data/)
    // })
  })
