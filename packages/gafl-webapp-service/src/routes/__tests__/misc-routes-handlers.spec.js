...
describe('guidance page handlers', () => {
  ...
  describe.each([
    ['Cookies', cookiesPageHandler],
    ['Accessibility', accessibilityPageHandler],
    ['Privacy policy', privacyPolicyPageHandler],
    ['Refund policy', refundPolicyPageHandler],
    ['OS Terms', osTermsPageHandler]
  ])('language code tests for %s page', (_page, pageHandler) => {
    it.each([
      ['?lang=cy', '?lang=cy'],
