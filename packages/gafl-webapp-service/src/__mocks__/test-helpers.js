...
export const MINOR_AT_ADVANCE_PURCHASE_MAX = moment().add(ADVANCED_PURCHASE_MAX_DAYS, 'day').subtract(MINOR_MAX_AGE + 1, 'years').add(1, 'day')
export const JUNIOR_AT_ADVANCE_PURCHASE_MAX = moment().add(ADVANCED_PURCHASE_MAX_DAYS, 'day').subtract(MINOR_MAX_AGE + 1, 'years')
