...
const getMessages = () => ({
  ...
  terms_conds_bulletpoint_1_notify: 'Notify bobo bulletpoint 1 part 1',
  terms_conds_bulletpoint_1_1_notify: 'Notify bobo bulletpoint 1 part 2',
  ...
  terms_conds_bulletpoint_4_notify_bobo: 'Notify bobo bulletpoint 4',
  terms_conds_bulletpoint_5_1_notify_bobo: 'Notify bobo bulletpoint 5 part 1',
  terms_conds_bulletpoint_5_2_notify_bobo: 'Notify bobo bulletpoint 5 part 2',
  terms_conds_bulletpoint_5_link_notify_bobo: 'Notify bobo bulletpoint 5 link',
  terms_conds_bulletpoint_6_notify_bobo: 'Notify bobo bulletpoint 6',
  terms_conds_bulletpoint_7_notify_bobo: 'Notify bobo bulletpoint 7',
  terms_conds_bulletpoint_7_link_notify_bobo: 'Notify bobo bulletpoint 7 link',
  ...
  terms_conds_bulletpoint_4_notify_self: 'Notify self bulletpoint 4',
  terms_conds_bulletpoint_5_1_notify_self: 'Notify self bulletpoint 5 part 1',
  terms_conds_bulletpoint_5_2_notify_self: 'Notify self bulletpoint 5 part 2',
  terms_conds_bulletpoint_5_link_notify_self: 'Notify self bulletpoint 5 link',
  terms_conds_bulletpoint_6_notify_self: 'Notify self bulletpoint 6',
  terms_conds_bulletpoint_7_notify_self: 'Notify self bulletpoint 7',
  terms_conds_bulletpoint_7_link_notify_self: 'Notify self bulletpoint 7 link',
