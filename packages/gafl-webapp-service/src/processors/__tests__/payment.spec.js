...
const createStatus = (recurringAgreement = false) => ({
  [COMPLETION_STATUS.recurringAgreement]: recurringAgreement
})
...
describe('preparePayment', () => {
  describe('provides the correct return url', () => {
    it.each(['http', 'https'])('uses SSL when "x-forwarded-proto" header is present, proto "%s"', proto => {
      ...
      const result = preparePayment(request, createTransaction(), createStatus())
    ...
    it('calls addLanguageCodeToUri with correct arguments', () => {
      ...
      preparePayment(request, createTransaction(), createStatus())
  ...
  `('provides the correct transaction amount of $expectedAmount when cost is $transaction.cost', ({ transaction, expectedAmount }) => {
    const result = preparePayment(createRequest(), transaction, createStatus())
  ...
  it('licenceTypeAndLengthDisplay is called with the expected arguments', () => {
    ...
    preparePayment(request, transaction, createStatus())
  ...
  it('return value of licenceTypeDisplay', () => {
    ...
    const result = preparePayment(createRequest(), createTransaction(), createStatus())
  ...
  describe('if there is only 1 permission and the user is buying on behalf of another, does not provide licensee info', () => {
    it('does not provide the prefilled_cardholder_details', () => {
      ...
      const result = preparePayment(createRequest(), boboTransaction, createStatus())
  ...
  describe('if the payment is a recurring payment', () => {
    it('set_up_agreement is set to agreementId', () => {
      ...
      const result = preparePayment(createRequest(), recurringPaymentTransaction, createStatus(true))
